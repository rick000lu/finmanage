...
$logout_url="http://localhost/xampp/finmanage/logout.php";
 ?>
<html>
  <head>
    <h1 style="text-align: center"><font color="#00ff00"><?php echo $user_name ?> 歡迎來到個人帳簿系統</font></h1>
  ...
  <body bgcolor="#000000">
    ...
    <h3 style="text-align: Center;"><a href="<?php echo $logout_url ?>"><font color="#00ffff">登出</font></a></h3>
  </body>
</html>
